...
export default {
  ...
  data(){
    return{
      ...
      commonOptionTitle : [{
        ...
        left: 10,
        top: 0,
        textStyle: {color: '#fff',fontSize: '14',fontWeight: 'bold',text: ""}
      }, {
        text: "",
        right: 10,
        top: 20,
  ...
  methods:{
    ...
    refreshChart(){
      ...
      dataAVBR = dataAVBR.map(function(item) {
        return 0;
      });
    ...
    initChartData(){
      ...
      if (keyArr.indexOf(curChart) == -1) { 
        ...
        for (var i = 0; i < that.cardIdArr.length; i++) {
          //上行速率
          allChartData[curChart].seriesDataUp[that.cardIdArr[i]] = {};
          allChartData[curChart].seriesDataUp[that.cardIdArr[i]]["ip"] = "";
          allChartData[curChart].seriesDataUp[that.cardIdArr[i]]["name"] = "";
          allChartData[curChart].seriesDataUp[that.cardIdArr[i]]["operator"] = "";
          allChartData[curChart].seriesDataUp[that.cardIdArr[i]]["data"] = new Array(xSplit).fill(0);
          //下行速率
          allChartData[curChart].seriesDataDown[that.cardIdArr[i]] = {};
          allChartData[curChart].seriesDataDown[that.cardIdArr[i]]["ip"] = "";
          allChartData[curChart].seriesDataDown[that.cardIdArr[i]]["name"] = "";
          allChartData[curChart].seriesDataDown[that.cardIdArr[i]]["data"] = new Array(xSplit).fill(0);
          //上行丢包率
          allChartData[curChart].seriesCardLost[that.cardIdArr[i]] = {};
          allChartData[curChart].seriesCardLost[that.cardIdArr[i]]["data"] = new Array(xSplit).fill(0);
        }
