<template>
  <div class="Record">
    <div class="Group" style="height:100%">
      <div class="GroupTitle popListTitle" @click="recordShow=!recordShow">
        录机管理
        <i class="titleIcon fa chevronStyle" :class="[recordShow == true ? 'fa-chevron-left': 'fa-chevron-right']"></i>
      </div>
      <mt-popup v-model="recordShow" position="right" popup-transition="popup-fade" class="rightPop">
        <div class="GroupItem" v-if="recordShow" id="userList" style="height:100%">
          <div class="popTitle">
            <div class="back">
              <div  @click="recordShow=false" class="popTitleBack">
                <i class="fa fa-chevron-left chevronWidth chevronColor" aria-hidden="true"></i>
                <span style="color:#fff">录机管理</span>
              </div>   
